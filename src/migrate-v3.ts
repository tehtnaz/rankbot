...
console.log(
    `Counts: Old_LevelRole: ${await LevelRole.count()}, Old_PersonXP: ${await PersonXP.count()}, LevelRole: ${await New_LevelRole.count()}, PersonXP: ${await New_PersonXP.count()}`
);
